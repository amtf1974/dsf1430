...
uses Windows, SysUtils, Messages, Classes, Graphics, Controls, Forms,
     Buttons, SkinCtrls, SkinData, ExtCtrls, SkinMenus, Menus;
...
begin
  ...
  FMonthMenu := TspSkinPopupMenu.Create(Self);
  FMenuPopup := False;
  FWeekNumbers := False;
  FShowToday := False;
...
destructor TspSkinMonthCalendar.Destroy;
begin
  FMonthMenu.Free;
  inherited;
end;

procedure  TspSkinMonthCalendar.MonthMenuClick(Sender: TObject);
var
...
procedure TspSkinMonthCalendar.CreateMonthMenu;
var
  I: Integer;
  MI: TMenuItem;
begin
...
procedure TspSkinMonthCalendar.MouseDown(Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  P: TPoint;
