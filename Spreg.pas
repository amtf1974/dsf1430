...
type
  ...
  TspHeaderSkinDataNameProperty = class(TspSkinDataNameProperty)
  public
    procedure GetValueList(List: TStrings); override;
  end;
  ...
  procedure TspHeaderSkinDataNameProperty.GetValueList(List: TStrings);
  begin
    List.Add('header');
    List.Add('resizetoolbutton');
    List.Add('resizebutton');
...
begin
  RegisterComponents('Skin Pack',  [TspDynamicSkinForm, TspSkinFrame, 
    ...
    TspSkinCheckBox, TspSkinRadioButton, TspSkinCheckRadioBox,
  ...
  RegisterPropertyEditor(TypeInfo(string), TspSkinListView, 'HeaderSkinDataName', TspHeaderSkinDataNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TspSkinFileEdit, 'LVHeaderSkinDataName', TspHeaderSkinDataNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TspSkinOpenDialog, 'LVHeaderSkinDataName', TspHeaderSkinDataNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TspSkinSaveDialog, 'LVHeaderSkinDataName', TspHeaderSkinDataNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TspSkinOpenPictureDialog, 'LVHeaderSkinDataName', TspHeaderSkinDataNameProperty);
  RegisterPropertyEditor(TypeInfo(string), TspSkinSavePictureDialog, 'LVHeaderSkinDataName', TspHeaderSkinDataNameProperty);
  ...
  RegisterPropertyEditor(TypeInfo(string), TspSkinButtonGroup, 'SkinDataName', TspCategorySkinDataNameProperty);
  ...
  RegisterPropertyEditor(TypeInfo(string), TspSkinHeaderControl, 'SkinDataName', TspHeaderSkinDataNameProperty);
