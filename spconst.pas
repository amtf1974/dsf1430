...
const
  ...
  SP_MSG_BTN_STRETCH_HINT = 'Fit Picture';
  ...
  SP_MSG_LV_LIST = 'List';
  SP_MSG_LV_THUMBNAILS = 'Thumbnails';
  SP_MSG_LV_BIGTHUMBNAILS = 'Big Thumbnails';
  SP_MSG_LV_VERYBIGTHUMBNAILS = 'Very Big Thumbnails';
