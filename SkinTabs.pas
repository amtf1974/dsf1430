...
procedure TspSkinPageControl.HideBorder;
begin
  FHideBorder := True;
  ReAlign;
end;

procedure TspSkinPageControl.ShowBorder;
begin
  FHideBorder := False;
  ReAlign;
end;
...
begin
  ...
  if not FScrollChecking then
    if FSkinUpDown <> nil then Limit := Width - FSkinUpDown.Width;
  j := 0;
  k := -1;
  for i := 0 to PageCount - 1 do
  if Pages[i].TabVisible
...
begin
  ...
  then
    begin
      ...
      if FHideBorder and not FHideTabs
      then
        begin
...
begin
  ...
  then
    ...
    begin
      ...
      then
        begin
          TB.Canvas.Brush.Color := SP_BTNACTIVECOLOR;
      ...
      then
        begin
          Frame3D(TB.Canvas, R, SP_BTNFRAMECOLOR, SP_BTNFRAMECOLOR, 1);
          TB.Canvas.Brush.Color := SP_BTNDOWNCOLOR;
          TB.Canvas.FillRect(R);
        end
      else
      if Active
